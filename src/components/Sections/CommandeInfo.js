...
const CommandeInfo = ({ isEchantillon = false, onTotalChange }) => {
  ...
  const infoMessages = {
    assurance:
      "L'assurance couvre la perte, le vol et les dommages pendant le transport. Elle représente 2% de la valeur déclarée de vos produits.",
    fraisPaiement:
      "Les frais de paiement correspondent aux frais de transaction et de gestion de votre commande.",
  };
  ...
  <>
    ...
    <div className="mb-3 flex justify-between items-center">
      <div className="flex items-center justify-center gap-1">
        ...
        >
          <option value="libreville">LBV</option>
          <option value="akanda">AKA</option>
          <option value="owendo">Owe</option>
        </select>
        {/* <button
          onClick={() => onInfoClick("frais")}
          className="text-gray-500"
    ...
    <div className="mb-3 flex justify-between items-center">
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={() => onInfoClick("frais")}
          className="text-gray-500"
          aria-label="Information sur les frais de "
        >
          <HelpCircle className="w-4 h-4" />
        </button>
      </div>
